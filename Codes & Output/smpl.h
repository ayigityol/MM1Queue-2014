...
/*             greater than 32767.                                    */
/* 																	  */
/* DZD (28/11/14) - changed random()-> randoM(MD vers.) else conflicts*/
/*                  with: /usr/include/cygwin/stdlib.h:29:6           */
/*                - also affects rand.c                               */
/**********************************************************************/
#include <stdio.h>
#include <string.h>
...
char *fname(int f);
				...
				*			with using SMPL						   *
				*			 									   *	
				*	Author:  Ahmet Yiðit YOL - 1862853			   *
				*			 Alican KARAMIL - 1801109			   *
				*			 Barýþcan ÇAMLIDERE - 1661420		   * 
				****************************************************/
char *mname(void);
...
int randoM(int i, int n); /* DZD(28/11/14): changed random()->randoM()*/
real ranf(void);
